...
#  documentation/Data/mot_postproc_compare.json at build time, which
...
MPP.all_figs()
_M = _mjson.load(_mio.open("documentation/Data/mot_postproc_compare.json", encoding="utf-8"))
...
for _half in (0, 1):
    ...
    footer(s, "Read Δ µε before Δ % : at 0.05 % strain a 10 µε difference is 2 % of the reading, "
              ...
              "documentation/Data/mot_matched_points.csv")
    pageno(s)
