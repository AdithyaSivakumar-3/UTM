...
s.shapes.add_picture("documentation/figures/V5/V5abc_stress_strain.png", Inches(0.35), Inches(1.55), width=Inches(8.5))
...
s.shapes.add_picture("documentation/figures/V5/V5abc_load_time.png", Inches(1.67), Inches(1.55), width=Inches(10.0))
...
s.shapes.add_picture("documentation/figures/V5/V5abc_stress_disp.png", Inches(1.67), Inches(1.55), width=Inches(10.0))
...
s.shapes.add_picture("documentation/figures/V5/V5abc_strain_disp.png", Inches(1.67), Inches(1.55), width=Inches(10.0))
...
s.shapes.add_picture("documentation/figures/V5/V5abc_offset.png", Inches(0.4), Inches(1.5), width=Inches(7.4))
