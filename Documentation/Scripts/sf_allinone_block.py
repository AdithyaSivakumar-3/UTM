...
_SF_LINE = {
    ...
    20: "Pick the two markers by hand — shape and size gates off; tracking follows your picks.",
}
...
banner(s, 0.40, _PY0 + 5 * (_PH + _PGY) - _PGY + 0.07, 12.55, 0.42,
       "%d of %d done and validated on the rig · %d built and waiting on rig time · always on "
       "underneath: load-collapse · stall guard · 4.5 kN / 30 mm · dead-DIC freeze."
