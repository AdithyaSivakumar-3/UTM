...
CACHE = os.path.abspath(os.path.join(HERE, "..", "Data", "pxmm_reasoning.json"))
...
# The two optical constants. The focal length is the rig's, recorded in PROJECT_OVERVIEW.md ("25 mm lens");
...
def build():
    mot = json.load(io.open(os.path.join(HERE, "..", "Data", "mot_postproc_compare.json"),
                            encoding="utf-8"))
    est = json.load(io.open(os.path.join(HERE, "..", "Data", "estimator_measurements.json"),
                            encoding="utf-8"))
