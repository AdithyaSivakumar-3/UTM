...
_rows2 = [["SF", "Feature", "Where it is shown working", "Kind of evidence"],
          ...
          ["20", "Manual blob selection", "tests script/test_manual_blobs.py", "9 offline tests on real frames"],
...
footer(s, "The list runs SF1–SF20 with no gaps (SF20 added 2026-09-06). Page numbers are this deck's own, "
...
# how the auto-calibrate score is built, from his own dialog
exec(open("documentation/scripts/autocal_score_block.py", encoding="utf-8").read())
...
img_fit(s, "documentation/figures/features/CalibratePxo_live marker.png", 0.4, 1.30, 12.55, 3.05)
...
banner(s, 0.4, 6.50, 12.55, 0.50,
       ...
       "SMART FEATURE HAS BEEN SHOWN WORKING — SF19 AND SF20 OFFLINE, THE REST ON THE RIG.",
       fill=GREEN_PASS, fg=DARK_GREEN, fs=10.5)
