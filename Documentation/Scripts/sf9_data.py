...
DATA = os.path.join(_APP, "Test data", "Smart Features - Advanced Test Modes data")
OUT = _HERE
...
S17_HALT = os.path.join(_APP, "Test data", "Fracture tests", "Specimen_S17_V2_Spray",
...
def fig_dic_halt():
    ...
    fig.tight_layout()
    return _save(fig, "documentation/figures/features/feat_dic_halt.png")
