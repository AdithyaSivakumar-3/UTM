...
_S20_MOT = _sjson.load(_sio.open("documentation/Data/mot_postproc_compare.json", encoding="utf-8"))
_S20_EST = _sjson.load(_sio.open("documentation/Data/estimator_measurements.json", encoding="utf-8"))
...
footer(s, "Software/UTM_PyQt6/app/utm_postproc.py (engine, no Qt) + utm_postdlg.py (the tab). The "
