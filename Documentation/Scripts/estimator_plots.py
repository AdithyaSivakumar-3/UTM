...
Every number comes from documentation/Data/estimator_measurements.json, which is written by
...
CACHE = os.path.abspath(os.path.join(HERE, "..", "Data", "estimator_measurements.json"))
sys.path.insert(0, os.path.abspath(os.path.join(ROOT, "Software", "UTM_PyQt6", "app")))
