...
pic_slide("PHASE 8.6.20 V6a: LOAD vs TIME", "documentation/figures/V6a/V6a_load_time.png", 143,
...
pic_slide("PHASE 8.6.20 V6a: STRESS vs STRAIN", "documentation/figures/V6a/V6a_stress_strain.png", 144,
...
pic_slide("PHASE 8.6.20 V6a: CAUCHY vs TRUE STRAIN", "documentation/figures/V6a/V6a_cauchy_true.png", 145,
          "Cauchy and True strain agree to <0.5 % (strains are small): ε_c = 0.0298 vs ε_t = 0.0294 at fracture.", x=0.4, y=1.5, w=8.9)
pic_slide("PHASE 8.6.20 V6a: STRESS vs CROSSHEAD POSITION", "documentation/figures/V6a/V6a_stress_position.png", 146,
...
pic_slide("PHASE 8.6.20 V6a: GAUGE STRAIN vs DISPLACEMENT", "documentation/figures/V6a/V6a_strain_position.png", 147,
...
pic_slide("V6 (100 % INFILL) vs V5 (50 % INFILL): LOAD vs TIME", "documentation/figures/V6a/V6a_v5_load_time.png", 150,
...
pic_slide("V6 (100 % INFILL) vs V5 (50 % INFILL): STRESS vs STRAIN", "documentation/figures/V6a/V6a_v5_stress_strain.png", 151,
...
pic_slide("V6 (100 % INFILL) vs V5 (50 % INFILL): STRESS vs DISPLACEMENT", "documentation/figures/V6a/V6a_v5_stress_disp.png", 152,
...
pic_slide("V6 (100 % INFILL) vs V5 (50 % INFILL): GAUGE STRAIN vs DISPLACEMENT", "documentation/figures/V6a/V6a_v5_strain_disp.png", 153,
...
s.shapes.add_picture("documentation/figures/V6a/V6a_offset_window.png", Inches(0.35), Inches(1.65), width=Inches(7.5))
...
s.shapes.add_picture("documentation/figures/V6a/V6a_epla_offset.png", Inches(8.05), Inches(1.4), width=Inches(5.05))
...
s.shapes.add_picture("documentation/figures/V6/V6_quintet_curves.png", Inches(0.32), Inches(1.6), width=Inches(6.5))
...
s.shapes.add_picture("documentation/figures/V6/V6_strength_repeat.png", Inches(0.32), Inches(1.6), width=Inches(6.7))
...
s.shapes.add_picture("documentation/figures/V6/V6_ductility.png", Inches(0.32), Inches(1.6), width=Inches(6.7))
...
s.shapes.add_picture("documentation/figures/V6/V6_offset_k.png", Inches(8.6), Inches(1.5), width=Inches(4.4))
...
FROOT = r"Software\UTM_PyQt6\Test data\Fracture tests"
...
footer(s, "Each specimen photo is an individually placed, croppable picture (…/Fracture tests/"
...
s.shapes.add_picture("documentation/figures/features/preload_schedule.png", Inches(6.75), Inches(1.65), width=Inches(6.2))
...
footer(s, "Feature in Software/UTM_PyQt6/app/main.py — PRELOAD_SPEED_KNOTS · TARGET_FACTOR 1.03 · OVERSHOOT_CAP 1.25 · "
...
_sf_cards = [
    ...
    (20, "Manual blob selection", "pick the pair, gates off", "built"),
]
...
footer(s, "Contiguous SF1–SF20 (renumbered 2026-09-02; SF20, manual blob selection, added 2026-09-06). Two entries were dropped earlier — a developer-only sim harness and optics-blocked Poisson (now FW1). Four safety layers on every driven test: load-collapse · stall guard · 4.5 kN / 30 mm · dead-DIC freeze.")
pageno(s)

# ---- Slide 170: SF 1 · DIC health HUD — modes  [content unchanged, was slide 176] ----
s = prs.slides.add_slide(BLANK); ju(s)
title(s, "DIC HEALTH HUD — LIVE TRACKING QUALITY")
pic_or_ph(s, "documentation/figures/features/DIC HUD UI Screenshot.png", 0.4, 1.35, 8.2, 0.8, "[ drop DIC HUD UI Screenshot.png here ]")
...
banner(s, 0.4, 5.55, 12.55, 0.9, "Rig-validated — position + force + DIC all zeroed, consoles + stress-strain plot cleared, from one press.",
       fill=GREEN_PASS, fg=DARK_GREEN, fs=12)
footer(s, "Feature in Software/UTM_PyQt6/app/main.py (Prepare specimen button). Validated 2026-07-28.")
pageno(s)
...
s.shapes.add_picture("documentation/figures/features/feat_report_s16.png", Inches(0.4), Inches(1.78), width=Inches(6.15))
header(s, 6.95, 1.28, 6.0, "Settings  —  save a setup, reload in 1 click")
pic_or_ph(s, "documentation/figures/features/Settings save_UI_Screenshot.png", 6.95, 1.85, 6.0, 0.6, "[ drop Settings save_UI_Screenshot.png here ]")
...
s.shapes.add_picture("documentation/figures/features/feat_autostop_proof.png", Inches(0.35), Inches(1.55), width=Inches(7.4))
...
s.shapes.add_picture("documentation/figures/features/feat_strainrate_proof.png", Inches(0.35), Inches(1.55), width=Inches(7.4))
...
s.shapes.add_picture("documentation/figures/features/feat_sr_plots.png", Inches(0.5), Inches(1.5), width=Inches(12.3))
...
banner(s, 0.4, 5.15, 12.55, 0.95, "Rig-validated — eases tension off the specimen + grips; live-SetSpeed only (no re-latch runaway); stops on target / rise-cap / timeout.",
       fill=GREEN_PASS, fg=DARK_GREEN, fs=12)
footer(s, "Feature in Software/UTM_PyQt6/app/main.py (Release preload button). Validated 2026-07-28.")
pageno(s)
...
pic_or_ph(s, "documentation/figures/UTM rig/Buckconverter_Enclosure_CAD.png", 0.5, 1.4, 6.3, 5.43, "[ drop Buckconverter_Enclosure_CAD.png here ]")
...
s.shapes.add_picture("documentation/figures/features/feat_motor_jitter.png", Inches(0.35), Inches(1.55), width=Inches(7.4))
...
s.shapes.add_picture("documentation/figures/features/feat_eng_vs_true.png", Inches(0.4), Inches(1.66), width=Inches(6.15))
...
s.shapes.add_picture("documentation/figures/features/feat_edgewidth.png", Inches(0.4), Inches(1.66), width=Inches(6.05))
...
banner(s, 0.45, 6.50, 12.45, 0.44,
       ...
       fill=GREEN_PASS, fg=DARK_GREEN, fs=11)
footer(s, "Motor AMP57TH76-4280 (1.85 Nm), gearbox EPL64/2 20:1, 5 mm lead — from PROJECT_OVERVIEW.md and the "
...
footer(s, "Raw CSVs: Software/UTM_PyQt6/Test data/Smart Features - Advanced Test Modes data/<specimen folder>/. Every number on "
...
banner(s, 0.4, 6.55, 12.55, 0.42,
       ...
       fill=GREEN_PASS, fg=DARK_GREEN, fs=12)
footer(s, "Raw: Software/UTM_PyQt6/Test data/Fracture tests/Specimen_S25… and …S26…/. "
...
footer(s, "S13 · 100 % infill · black PLA, white spray dots · 2026-08-18 · "
          "Software/UTM_PyQt6/Test data/Fracture tests/Specimen_S13_V2_Spray_Video7/")
pageno(s)
...
banner(s, 0.4, 6.05, 12.55, 0.80,
       ...
       fill=GREEN_PASS, fg=DARK_GREEN, fs=12)
footer(s, "Software/UTM_PyQt6/Test data/Fracture tests/Specimen_S27_V1_Spray_Video4/ and "
...
sf_overview([
    ...
    (19, "Noise capture",
     ...
     "built"),
    (20, "Manual blob selection",
     "Pick the two markers by hand and OVERRIDE auto detection — for markers the shape and "
     "size gates keep rejecting. Seeds follow the markers, so one pick survives the pull; the "
     "pair guards stay on. In both camera rows and the guided wizard.",
     "built"),
])
...
footer(s, "Contiguous SF1–SF20 (SF20 added 2026-09-06): every card is something the OPERATOR "
          "invokes — measured Poisson (optics-blocked) lives in future work FW1 instead. SF19 "
          "and SF20 are built and verified offline but have not yet run a real pull.")
pageno(s)
...
banner(s, 0.4, 6.34, 12.55, 0.52,
       "ALL FOUR PREDICTIONS HOLD — and with UTS bands read from PRINTED-PART literature "
       "(Chacón 2017 + Tymrak 2014 for PLA; Durgashyam 2019 + Hsueh 2021 for PETG) every "
       "measured value sits IN BAND. The first draft quoted datasheet-grade 50–60 / 45–53 and "
       "called both UTS 'below band' — corrected 2026-09-06; the knock-down story belongs to the "
       "E-PLA DATASHEET comparison (58 MPa → 80 % delivered), where it still stands.",
...
# ---- how strain is measured: glued / clipped / watched, and the clip-on's principle
exec(open("documentation/scripts/instrument_slides_block.py", encoding="utf-8").read())

# ---- the fracture survey: where every specimen broke, PLA vs PETG at the break
exec(open("documentation/scripts/fracture_slides_block.py", encoding="utf-8").read())

# ---- the one-page index of every smart feature
exec(open("documentation/scripts/sf_allinone_block.py", encoding="utf-8").read())
exec(open("documentation/scripts/camera_res_block.py", encoding="utf-8").read())
exec(open("documentation/scripts/humidity_slides_block.py", encoding="utf-8").read())
exec(open("documentation/scripts/pcf_slides_block.py", encoding="utf-8").read())
exec(open("documentation/scripts/px2strain_slides_block.py", encoding="utf-8").read())
# futurework_slides_block.py is NOT wired in — his call 2026-09-06: V6a stays untouched for
# now; the future-work slide was appended directly to the Weekly (wk_append_futurework.py).
