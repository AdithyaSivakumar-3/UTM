...
settings, spool and machine. For 100 % infill printed parts:
    ...
    PLA   stronger and much stiffer, and brittle    UTS 32-60 MPa, E 3.0-3.6 GPa, eps_f 3-8 %
    PETG  a little weaker, far less stiff, tougher  UTS 30-50 MPa, E 1.7-2.1 GPa, eps_f 5-25 %

UTS bands corrected 2026-09-06: the first draft quoted 50-60 / 45-53, which are DATASHEET-grade
figures, and both measured values sat "below band" because of it. Printed-part literature is
wider: PLA 32-60 (Chacon et al. 2017, doi 10.1016/j.matdes.2017.03.065, weakest orientation ~32;
Tymrak et al. 2014, doi 10.1016/j.matdes.2014.02.038, up to ~60; Prusament PLA TDS 50.8 inside)
and PETG 30-50 (Durgashyam et al. 2019, doi 10.1016/j.matpr.2019.06.082, low end ~30; Hsueh et
al. 2021, doi 10.3390/polym13111758, 40-50 by temperature; Prusament PETG TDS 47 inside). These
match the Chacon 32-50/32-60 band the validation slides already used - one band everywhere now.
...
D = os.path.join(APP, "Test data", "Fracture tests")
RUNS = {
...
LIT = {"PLA":  {"UTS": (32, 60), "E": (3.0, 3.6), "ef": (3, 8)},
       "PETG": {"UTS": (30, 50), "E": (1.7, 2.1), "ef": (5, 25)}}
