...
Both read documentation/Data/mot_postproc_compare.json, which mot_postproc_compare.py writes, so a
...
CACHE = os.path.abspath(os.path.join(HERE, "..", "Data", "mot_postproc_compare.json"))
