...
sys.path.insert(0, _os.path.join("Software", "UTM_PyQt6", "app"))
import utm_analysis as UA

CSV = _os.path.join("Software", "UTM_PyQt6", "Test data", "Fracture tests",
...
S16_CSV = _os.path.join("Software", "UTM_PyQt6", "Test data", "Fracture tests",
