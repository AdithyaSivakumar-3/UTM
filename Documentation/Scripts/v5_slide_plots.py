...
ax.grid(alpha=0.3)
plt.tight_layout(); plt.savefig("documentation/figures/V5/V5_slide_load_time.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V5/V5_slide_stress_strain.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V5/V5_slide_cauchy_true.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V5/V5_slide_stress_position.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V5/V5_slide_strain_position.png", dpi=150, bbox_inches="tight"); plt.close()
