...
tb(s, 7.00, 1.44, 5.95, 1.36,
   ...
   "•  Both of those ARE “Path 2” of ⟪WHERE THE GREY LEVELS COME BACK — TWO PATHS, NOT ONE⟫ — "
   "that closed loop is IMPLEMENTED, not planned: auto-calibrate closes it at calibration, and "
   "the live badge closes it continuously during a run.",
   fs=9.2, colour=BLACK)
