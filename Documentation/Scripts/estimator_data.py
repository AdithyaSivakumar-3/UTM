...
documentation/Data/estimator_measurements.json. The plots and slides read that cache rather than
...
CACHE = os.path.join(HERE, "..", "Data", "estimator_measurements.json")
