...
![](Documentation/Figures/UTM%20rig/GUI.png)
...
| `Software/UTM_PyQt6/app/main.py` | The application. Control loop, live plots, CSV export, all UI. |
| `Software/UTM_PyQt6/app/camera_manager.py` | Camera, thresholding, marker detection, strain. |
| `Software/UTM_PyQt6/app/utm_analysis.py` | The canonical analyser. Every script and the app share it — do not re-implement it. |
