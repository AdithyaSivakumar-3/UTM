...
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_load_time.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_stress_strain.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_cauchy_true.png", dpi=150, bbox_inches="tight"); plt.close()
...
ax.text(0.2, uts["sig"]*0.55,
        ...
        fontsize=11, color="#444", bbox=dict(facecolor="#E7F1F8", edgecolor="none", boxstyle="round,pad=0.4"))
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_stress_position.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_strain_position.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_v5_load_time.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_v5_stress_strain.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_v5_stress_disp.png", dpi=150, bbox_inches="tight"); plt.close()
...
ax.text(2.8, 0.004, "Both sit below the ideal line (rig compliance) with SIMILAR slopes —\n~half the travel reaches the gauge in both (gauge share 55 % vs 52 %).\n100 % just travels further (stronger + more extensible).", fontsize=10.5, color="#444",
        bbox=dict(facecolor="#fdecea", edgecolor="none", boxstyle="round,pad=0.4"))
plt.tight_layout(); plt.savefig("documentation/figures/V6a/V6a_v5_strain_disp.png", dpi=150, bbox_inches="tight"); plt.close()
