...
plt.tight_layout(); plt.savefig("documentation/figures/V6/V6_quintet_curves.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6/V6_strength_repeat.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6/V6_ductility.png", dpi=150, bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig("documentation/figures/V6/V6_offset_k.png", dpi=150, bbox_inches="tight"); plt.close()
