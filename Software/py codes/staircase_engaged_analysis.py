...
CSV_PATH = r"Software\UTM_PyQt6\Test data\Smart Features - Advanced Test Modes data\8.6.3\UTM_Test_20260605_152501_V4b_Staricase_Tension.csv"
OUT_PNG = "documentation/figures/V4/V4b_engaged_regime.png"
