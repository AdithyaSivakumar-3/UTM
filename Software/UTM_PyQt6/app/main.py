...
# Path to the UI file
UI_FILE = Path(__file__).parent.parent / "ui" / "utm_mainwindow.ui"
...
class UTMApplication(QMainWindow):
    ...
    def on_mode_help(self):
        ...
        path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "ui", "help", f"{slug}.png")
        caps = {
    ...
    CAPTURE_ROOT = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "output", "captures")
